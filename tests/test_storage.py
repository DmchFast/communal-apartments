...
def test_load_user_meters_returns_empty_for_unknown_user(tmp_path: Path, monkeypatch) -> None:
...
def test_save_and_load_user_readings(tmp_path: Path, monkeypatch) -> None:
...
def test_load_user_readings_converts_meter_id_to_int(tmp_path: Path, monkeypatch) -> None:
